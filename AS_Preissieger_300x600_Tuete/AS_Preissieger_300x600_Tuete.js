...
if (reversed == null) { reversed = false; }
	...
	this.timeline.addTween(cjs.Tween.get(this.instance_5).wait(18).to({_off:false},0).to({x:45.5,y:58.5},10,cjs.Ease.quadIn).wait(11).to({y:51.5},8).wait(104).to({y:58.5},7).to({_off:true},46).wait(45));
	...
	this.instance_9.setTransform(150,295.85,1,1.0003);
	this.instance_9._off = true;

	this.timeline.addTween(cjs.Tween.get(this.instance_8).to({_off:true,scaleY:1.0003,y:295.85},18,cjs.Ease.quadIn).wait(231));
	this.timeline.addTween(cjs.Tween.get(this.instance_9).to({_off:false},18,cjs.Ease.quadIn).wait(21).to({scaleY:1,y:295.8},0).to({scaleX:1.05,scaleY:1.05,x:149.95,y:295.75},14).wait(91).to({startPosition:0},0).to({scaleX:1,scaleY:1},14).wait(91));
	...
	this.instance_11.setTransform(150,15.95,1,1.0003);

	this.timeline.addTween(cjs.Tween.get({}).to({state:[{t:this.instance_10}]}).to({state:[{t:this.instance_11}]},18).wait(231));
	this.timeline.addTween(cjs.Tween.get(this.instance_10).to({_off:true,scaleY:1.0003},18,cjs.Ease.quadIn).wait(231));
	...
	this.instance_13.setTransform(150,469.7,1,1.0003);

	this.timeline.addTween(cjs.Tween.get({}).to({state:[{t:this.instance_12}]}).to({state:[{t:this.instance_13}]},18).wait(231));
	this.timeline.addTween(cjs.Tween.get(this.instance_12).to({_off:true,scaleY:1.0003,y:469.7},18,cjs.Ease.quadIn).wait(231));
	...
	this.instance_15.setTransform(150,471.45,1,1.0003);

	this.timeline.addTween(cjs.Tween.get({}).to({state:[{t:this.instance_14}]}).to({state:[{t:this.instance_15}]},18).wait(231));
	this.timeline.addTween(cjs.Tween.get(this.instance_14).to({_off:true,scaleY:1.0003,y:471.45},18,cjs.Ease.quadIn).wait(231));

	// Vektor_Smartobjekt_1
	this.instance_16 = new lib.Tween9("synched",0);
	this.instance_16.setTransform(150,474.8,1,1.0016);

	this.instance_17 = new lib.Tween10("synched",0);
	this.instance_17.setTransform(150,474.95,1,1.0019);

	this.timeline.addTween(cjs.Tween.get({}).to({state:[{t:this.instance_16}]}).to({state:[{t:this.instance_17}]},18).wait(231));
	this.timeline.addTween(cjs.Tween.get(this.instance_16).to({_off:true,scaleY:1.0019,y:474.95},18,cjs.Ease.quadIn).wait(231));
