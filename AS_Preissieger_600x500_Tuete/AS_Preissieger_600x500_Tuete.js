...
if (reversed == null) { reversed = false; }
	...
	this.timeline.addTween(cjs.Tween.get(this.instance).wait(19).to({_off:false},0).to({x:34.9},9,cjs.Ease.quadIn).wait(11).to({y:39.5},7).wait(106).to({y:46.5},6).wait(36).to({alpha:0.0313},9).to({_off:true},1).wait(45));
	...
	this.instance_24.setTransform(149.95,121.25,1.0023,1);
	this.instance_24._off = true;

	this.timeline.addTween(cjs.Tween.get(this.instance_23).to({_off:true,scaleX:1.0023,x:149.95,y:121.25},18,cjs.Ease.quadIn).wait(231));
	this.timeline.addTween(cjs.Tween.get(this.instance_24).to({_off:false},18,cjs.Ease.quadIn).wait(21).to({scaleX:1,x:149.65},0).to({scaleX:1.13,scaleY:1.13},15).wait(90).to({startPosition:0},0).to({scaleX:1,scaleY:1,x:149.6},14).wait(91));
	...
	this.instance_26.setTransform(149.95,16,1.0023,1);

	this.timeline.addTween(cjs.Tween.get({}).to({state:[{t:this.instance_25}]}).to({state:[{t:this.instance_26}]},18).wait(231));
	this.timeline.addTween(cjs.Tween.get(this.instance_25).to({_off:true,scaleX:1.0023,x:149.95,y:16},18,cjs.Ease.quadIn).wait(231));
	...
	this.instance_28.setTransform(149.95,119.75,1.0023,1);

	this.timeline.addTween(cjs.Tween.get({}).to({state:[{t:this.instance_27}]}).to({state:[{t:this.instance_28}]},18).wait(231));
	this.timeline.addTween(cjs.Tween.get(this.instance_27).to({_off:true,scaleX:1.0023,x:149.95,y:119.75},18,cjs.Ease.quadIn).wait(231));
	...
	this.instance_30.setTransform(149.95,121.5,1.0023,1);

	this.timeline.addTween(cjs.Tween.get({}).to({state:[{t:this.instance_29}]}).to({state:[{t:this.instance_30}]},18).wait(231));
	this.timeline.addTween(cjs.Tween.get(this.instance_29).to({_off:true,scaleX:1.0023,x:149.95,y:121.5},18,cjs.Ease.quadIn).wait(231));
	...
	this.instance_32.setTransform(149.95,125,1.0023,1);

	this.timeline.addTween(cjs.Tween.get({}).to({state:[{t:this.instance_31}]}).to({state:[{t:this.instance_32}]},18).wait(231));
	this.timeline.addTween(cjs.Tween.get(this.instance_31).to({_off:true,scaleX:1.0023,x:149.95},18,cjs.Ease.quadIn).wait(231));
