...
p.nominalBounds = new cjs.Rectangle(0,0,346,279);
...
p.nominalBounds = new cjs.Rectangle(0,0,226,30);
...
p.nominalBounds = new cjs.Rectangle(0,0,289,31);
...
p.nominalBounds = new cjs.Rectangle(0,0,307,31);
...
p.nominalBounds = new cjs.Rectangle(0,0,353,44);


(lib.Rechteck_Kopie = function() {
	this.initialize(img.Rechteck_Kopie);
}).prototype = p = new cjs.Bitmap();
p.nominalBounds = new cjs.Rectangle(0,0,244,44);
...
p.nominalBounds = new cjs.Rectangle(0,0,324,44);


(lib.Rot = function() {
	this.initialize(img.Rot);
}).prototype = p = new cjs.Bitmap();
p.nominalBounds = new cjs.Rectangle(0,0,400,1129);


(lib.Tuete = function() {
	this.initialize(img.Tuete);
}).prototype = p = new cjs.Bitmap();
p.nominalBounds = new cjs.Rectangle(0,0,400,528);


(lib.WEIL_DER_ALLTAG = function() {
	this.initialize(img.WEIL_DER_ALLTAG);
}).prototype = p = new cjs.Bitmap();
p.nominalBounds = new cjs.Rectangle(0,0,337,31);// helper functions:
...
}).prototype = getMCSymbolPrototype(lib.Tuete_1, new cjs.Rectangle(0,0,200,264), null);
...
}).prototype = getMCSymbolPrototype(lib.Legal_Text_1, new cjs.Rectangle(0,0,175.5,29), null);
...
}).prototype = getMCSymbolPrototype(lib.KuMoSiegel, new cjs.Rectangle(0,0,173,139.5), null);
...
if (reversed == null) { reversed = false; }
	...
	this.instance.setTransform(4,3,0.5,0.5);
	...
	this.instance_2.setTransform(5,28,0.5,0.5);
	...
	this.instance_4.setTransform(5,52,0.5,0.5);

	this.timeline.addTween(cjs.Tween.get(this.instance_4).wait(1));

	// Rechteck_Kopie_2
	this.instance_5 = new lib.Rechteck_Kopie_2();
	this.instance_5.setTransform(0,49,0.5,0.5);

	this.timeline.addTween(cjs.Tween.get(this.instance_5).wait(1));

	this._renderFirstFrame();

}).prototype = getMCSymbolPrototype(lib.Headline_1, new cjs.Rectangle(0,0,176.5,71.5), null);
...
}).prototype = getMCSymbolPrototype(lib.EndLogo, new cjs.Rectangle(0,0,139,150), null);
...
}).prototype = getMCSymbolPrototype(lib.deraldipreis, new cjs.Rectangle(0,0,162,22), null);
...
if (reversed == null) { reversed = false; }
	...
	this.shape.graphics.f("#FF0000").s().p("EgRBAi2MAAAhFrMAiDAAAMAAABFrg");
	this.shape.setTransform(100.0066,300.034,0.9174,1.3455);

	this.timeline.addTween(cjs.Tween.get(this.shape).wait(1));

	this._renderFirstFrame();

}).prototype = getMCSymbolPrototype(lib.clickable_area, new cjs.Rectangle(0,0.1,200,600), null);


// stage content:
(lib.AS_Preissieger_200x600_Tüte_gerastert = function(mode,startPosition,loop,reversed) {
if (loop == null) { loop = true; }
if (reversed == null) { reversed = false; }
	var props = new Object();
	props.mode = mode;
	...
	this.btn.name = "btn";
	this.btn.setTransform(100,300,1,0.9999,0,0,0,100,300);
	...
	this.instance.setTransform(288.2,177.8,1,1,0,0,0,88.2,35.8);
	this.instance._off = true;

	this.timeline.addTween(cjs.Tween.get(this.instance).wait(19).to({_off:false},0).to({x:100.2},9,cjs.Ease.quadIn).wait(61).to({alpha:0.1016},9,cjs.Ease.quadOut).to({_off:true},1).wait(150));

	// der_aldi_preis
	this.instance_1 = new lib.deraldipreis();
	this.instance_1.setTransform(281,224.5,1,1,0,0,0,81,11);
	this.instance_1._off = true;

	this.timeline.addTween(cjs.Tween.get(this.instance_1).wait(34).to({_off:false},0).to({x:93,y:226},9,cjs.Ease.quadIn).wait(46).to({alpha:0.1016},9,cjs.Ease.quadOut).to({_off:true},1).wait(150));

	// Logo
	this.instance_2 = new lib.Logo();
	this.instance_2.setTransform(230.5,64.5,1,1,0,0,0,30.5,36.5);
	this.instance_2._off = true;

	this.timeline.addTween(cjs.Tween.get(this.instance_2).wait(19).to({_off:false},0).to({x:43.5},9,cjs.Ease.quadIn).wait(11).to({y:48.5},5).wait(100).to({y:64.5},4).wait(46).to({alpha:0.0117},4).to({_off:true},1).wait(50));

	// Tuete
	this.instance_3 = new lib.Tuete_1();
	this.instance_3.setTransform(100,408,0.5,0.5,0,0,0,100,132);
	this.instance_3.alpha = 0.1016;
	this.instance_3._off = true;

	this.timeline.addTween(cjs.Tween.get(this.instance_3).wait(39).to({_off:false},0).to({scaleX:1,scaleY:1,alpha:1},9,cjs.Ease.quadOut).wait(41).to({x:-100},9,cjs.Ease.quadIn).to({_off:true},1).wait(150));

	// KuMo_Siegel
	this.instance_4 = new lib.KuMoSiegel();
	this.instance_4.setTransform(286.5,292.8,1,1,0,0,0,86.5,69.8);
	this.instance_4._off = true;

	this.timeline.addTween(cjs.Tween.get(this.instance_4).wait(89).to({_off:false},0).to({x:100.5},9,cjs.Ease.quadIn).wait(41).to({x:-86.5},9,cjs.Ease.quadIn).to({_off:true},1).wait(100));

	// Legal_Text
	this.instance_5 = new lib.Legal_Text_1();
	this.instance_5.setTransform(99.8,562.5,1,1,0,0,0,87.8,14.5);
	this.instance_5.alpha = 0.1016;
	this.instance_5._off = true;

	this.timeline.addTween(cjs.Tween.get(this.instance_5).wait(89).to({_off:false},0).to({alpha:1},9).wait(41).to({alpha:0.1016},9).to({_off:true},1).wait(100));

	// GFA
	this.instance_6 = new lib.GFA_1();
	this.instance_6.setTransform(279,300.2,1,1,0,0,0,79,112.2);
	this.instance_6._off = true;

	this.timeline.addTween(cjs.Tween.get(this.instance_6).wait(139).to({_off:false},0).to({x:100},9,cjs.Ease.quadIn).wait(46).to({regX:79.4,scaleX:0.075},4).to({_off:true},1).wait(50));

	// End_Logo
	this.instance_7 = new lib.EndLogo();
	this.instance_7.setTransform(100.5,300,0.075,1,0,0,0,70,75);
	this.instance_7._off = true;

	this.timeline.addTween(cjs.Tween.get(this.instance_7).wait(199).to({_off:false},0).to({regX:69.5,scaleX:1},4).wait(46));

	// Cyan
	this.instance_8 = new lib.Tween1("synched",0);
	this.instance_8.setTransform(100,-51);

	this.instance_9 = new lib.Tween2("synched",0);
	this.instance_9.setTransform(100,294);
	this.instance_9._off = true;

	this.timeline.addTween(cjs.Tween.get(this.instance_8).to({_off:true,y:294},18,cjs.Ease.quadIn).wait(231));
	this.timeline.addTween(cjs.Tween.get(this.instance_9).to({_off:false},18,cjs.Ease.quadIn).wait(21).to({startPosition:0},0).to({scaleX:1.1,scaleY:1.1,x:99.95,y:293.95},9).wait(92).to({startPosition:0},0).to({scaleX:1,scaleY:1},8).wait(101));
	...
	this.instance_11.setTransform(100,17.25);
	...
	this.instance_12.setTransform(100,146.25);

	this.instance_13 = new lib.Tween6("synched",0);
	this.instance_13.setTransform(100,297.25);

	this.timeline.addTween(cjs.Tween.get({}).to({state:[{t:this.instance_12}]}).to({state:[{t:this.instance_13}]},18).wait(231));
	this.timeline.addTween(cjs.Tween.get(this.instance_12).to({_off:true,y:297.25},18,cjs.Ease.quadIn).wait(231));

	// Orange
	this.instance_14 = new lib.Tween7("synched",0);
	this.instance_14.setTransform(100,256.25);

	this.instance_15 = new lib.Tween8("synched",0);
	this.instance_15.setTransform(100,300.25);

	this.timeline.addTween(cjs.Tween.get({}).to({state:[{t:this.instance_14}]}).to({state:[{t:this.instance_15}]},18).wait(231));
	this.timeline.addTween(cjs.Tween.get(this.instance_14).to({_off:true,y:300.25},18,cjs.Ease.quadIn).wait(231));
	...
	this.instance_17.setTransform(100,307.5);
...
p.nominalBounds = new cjs.Rectangle(-100,-29,476.5,629);
// library properties:
lib.properties = {
	id: '4014D8F1FBD046D8B5280956D505F524',
	width: 200,
	height: 600,
	fps: 24,
	color: "#FFFFFF",
...
an.compositions['4014D8F1FBD046D8B5280956D505F524'] = {
